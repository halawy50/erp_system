...
class EditEmployeePage extends StatefulWidget {
  UserModel userModel;
  UserRepo userRepo;
  EditEmployeePage({super.key , required this.userRepo , required this.userModel});
...
class _EditEmployeePageState extends State<EditEmployeePage> {
  ...
  void initState() {
    ...
    _jobTitleController.text = widget.userModel.jobTitle;
    _emailController.text = widget.userModel.userName;
    _passwordController.text = widget.userModel.password;

    isWarehouseManagement = widget.userModel.isWarehouseManagement==true?itemsWarehouseManagement[0] : itemsWarehouseManagement[1];
    isPurchase = widget.userModel.isPurchase==true?itemsPurchase[0] : itemsPurchase[1];
    isMixProduction = widget.userModel.isMixProduction==true?itemsMixProduction[0] : itemsMixProduction[1];
    isPrescriptionManagement = widget.userModel.isPrescriptionManagement==true?itemsPrescriptionManagement[0] : itemsPrescriptionManagement[1];
    isInventory = widget.userModel.isInventory==true?itemsInventory[0] : itemsInventory[1];
    isHistory = widget.userModel.isHistory==true?itemsHistory[0] : itemsHistory[1];
    ...
    isDeletePurchase = widget.userModel.deletePurchase;

    isAddMixProduction = widget.userModel.insertMixProduction;
    isUpdateMixProduction = widget.userModel.updateMixProduction;
    isDeleteMixProduction = widget.userModel.deleteMixProduction;

    isAddPrescriptionManagement = widget.userModel.insertPrescriptionManagement;
    isUpdatePrescriptionManagement = widget.userModel.updatePrescriptionManagement;
    isDeletePrescriptionManagement = widget.userModel.deletePrescriptionManagement;
  ...
  void dispose() {
    ...
    _jobTitleController.removeListener(_updateState);
                        ...
                        InkWell(
                          onTap: () async {
                            ...
                            if(_nameController.text.isNotEmpty &&
                              ...
                              bool checkUpdate = await widget.userRepo.updateUser(user);
                              if (checkUpdate) {
                                showSnackbar(context, "تم تحديث البيانات", backgroundColor: Colors.green);
                                Navigator.pop(context);
                              } else {
                                showSnackbar(context, "يوجد مشكلة", backgroundColor: Colors.red);
                              }
                            }
